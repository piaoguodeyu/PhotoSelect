...
public class PhotoPickerFragment extends Fragment {
    ...
    public static PhotoPickerFragment newInstance(boolean showCamera, boolean showGif,
        ...
        args.putBoolean(CameraKeys.EXTRA_CAMERA, showCamera);
        args.putBoolean(CameraKeys.EXTRA_GIF, showGif);
        args.putBoolean(CameraKeys.EXTRA_PREVIEW_ENABLED, previewEnable);
        args.putInt(CameraKeys.EXTRA_COLUMN, column);
        args.putInt(CameraKeys.EXTRA_COUNT, maxCount);
        args.putStringArrayList(CameraKeys.EXTRA_ORIGIN, originalPhotos);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        originalPhotos = getArguments().getStringArrayList(CameraKeys.EXTRA_ORIGIN);

        column = getArguments().getInt(CameraKeys.EXTRA_COLUMN, CameraKeys.DEFAULT_COLUMN_NUMBER);
        boolean showCamera = getArguments().getBoolean(CameraKeys.EXTRA_CAMERA, true);
        boolean previewEnable = getArguments().getBoolean(CameraKeys.EXTRA_PREVIEW_ENABLED, true);
        ...
        boolean showGif = getArguments().getBoolean(CameraKeys.EXTRA_GIF);
        mediaStoreArgs.putBoolean(CameraKeys.EXTRA_SHOW_GIF, showGif);
